...
sys.path.append('/Users/jmh/dev/sample_restraint/build/src/pythonmodule')
...
potential1.name = "linear_restraint_1"
...
potential2.name = "linear_restraint_2"
