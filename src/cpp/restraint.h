//
// Created by Eric Irrgang on 2019-03-06.
//

#ifndef MDSTRING_RESTRAINT_H
#define MDSTRING_RESTRAINT_H
...
class Restraint : public gmx::IRestraintPotential, private PotentialT
{
    public:
        ...
        Restraint(std::vector<int> sites,
        ...
        gmx::PotentialPointData evaluate(gmx::Vector r1,
                                         ...
                                         double t) override
        {
            return PotentialT::calculate(r1,
                             r2,
                             t);
        };
